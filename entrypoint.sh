...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/e3ea85c3-4e66-4b3d-8644-ec7dbccc3202-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="e3ea85c3-4e66-4b3d-8644-ec7dbccc3202"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/e3ea85c3-4e66-4b3d-8644-ec7dbccc3202-vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="e3ea85c3-4e66-4b3d-8644-ec7dbccc3202"
fi
echo ${Vmess_UUID}
